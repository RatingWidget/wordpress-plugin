...
(function($) {
	...
	function disableEditor(bool) {
		if ( bool ) {
			...
			js_editor.container.style.opacity = 0.5;
			js_editor.getSession().setMode("ace/mode/text");
			js_editor.renderer.$cursorLayer.element.style.opacity = 0;
		} else {
			js_editor.setOptions({
			...
			js_editor.container.style.opacity=1;
			js_editor.getSession().setMode("ace/mode/javascript");
			js_editor.renderer.$cursorLayer.element.style.opacity = 1;
		}
	}
