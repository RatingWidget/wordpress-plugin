...
extract($VARS);
?>
<div><?php echo sprintf(__("Hey, I noticed you just crossed the %d votes on RatingWidget - that's awesome! Could you please do me a BIG favor and give it a 5-star rating on WordPress? Just to help us spread the word and boost our motivation. %s", WP_RW__ID), $min_votes_trigger, '<br /><br /><strong><em>~ Vova Feldman</em></strong>'); ?></div>
