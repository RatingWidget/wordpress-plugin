		...
		if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) :
			...
			class RW_WooCommerce extends RW_AbstractExtension
			{
				...
				function GetDefaultAlign()
				{
					...
					return array(
						WP_RW__WOOCOMMERCE_PRODUCTS_ALIGN => (object)array('ver' => 'bottom', 'hor' => 'left'), // dummy
						WP_RW__WOOCOMMERCE_COLLECTION_PRODUCTS_ALIGN => (object)array('ver' => 'bottom', 'hor' => 'left'), // dummy
					);
				}
